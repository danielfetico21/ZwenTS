...
Short conventions from the [API design review](./reviews/api-review.md). Complements [semver-contract.md](./semver-contract.md). Throws cheat-sheet: [api-throws.md](./api-throws.md).
