...
Handlers may return `Result` — `createApp` unwraps success and routes `AppError` failures through Problem Details.

See also [Result helpers](/guide/result) and RFC 0006 in the monorepo `docs/rfcs/`.
